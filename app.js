...
function savePlan(){
  ...
  if(window._savePlanFS) window._savePlanFS(plan);
  updateStats();
...
function saveProfile(){
  ...
  if(window._saveCompanyFS) window._saveCompanyFS(S.company);
...
function addEmployee(){
  ...
  if(window._saveEmployeesFS) window._saveEmployeesFS(S.employees);
